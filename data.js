...
const NONSENSE = {
  ...
  duck: ["quack.", "quack?", "QUACK.", "...", "quack quack.", "the duck left.", "quack. (no.)", "kcauq."],
  away: ["come back", "hello?", "banana?", "quack", "12"],
  timeNotes: { 12: "twelve!", 30: "soup is ready.", 60: "one minute. wow.", 404: "404.", 600: "drink water.", 3600: "an hour??" },
};
